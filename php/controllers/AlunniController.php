...
class AlunniController
{
  ...
  public function viewAlunno (Request $request, Response $response, $args){
    ...
    if($result && $mysqli_connection->affected_rows > 0){
      ...
      $response->getBody()->write(json_encode(array("message"=>$mysqli_connection->error, "Alunno non trovato")));
  ...
  public function createAlunno (Request $request, Response $response, $args){
    ...
    if($result && $mysqli_connection->affected_rows > 0){
      ...
      $response->getBody()->write(json_encode(array("message"=>$mysqli_connection->error, "Impossibile creare alunno")));
      return $response->withHeader("Content-type", "application/json")->withStatus(404);
    }
  }
  ...
  public function updateAlunno (Request $request, Response $response, $args){
    ...
    if($result && $mysqli_connection->affected_rows > 0){
      ...
      $response->getBody()->write(json_encode(array("message"=>$mysqli_connection->error, "Impossibile aggiornare alunno")));
      return $response->withHeader("Content-type", "application/json")->withStatus(404);
    }
  }
  ...
  public function deleteAlunno (Request $request, Response $response, $args){
    ...
    if($result && $mysqli_connection->affected_rows > 0){
      ...
      $response->getBody()->write(json_encode(array("message"=>$mysqli_connection->error, "Impossibile rimuovere alunno")));
      return $response->withHeader("Content-type", "application/json")->withStatus(404);
    }
  }
